...
use ttymap::core::map::render::renderer::{LayerData, Renderer, TileData};
use ttymap::core::map::render::view::VisibleTile;
use ttymap::core::map::styler::Styler;
...
fn build_tile_data(decoded: ttymap::core::map::tile::decode::DecodedTile) -> Vec<TileData> {
    let vis = VisibleTile {
        x: 0,
        y: 0,
        z: 14,
