...
//! [`LuaRegistry`](crate::registrar::LuaRegistry). The
...
///
/// `:remove()` calls
/// [`LuaRegistry::remove_palette_entry`](crate::registrar::LuaRegistry::remove_palette_entry)
...
///
/// `:remove()` calls
/// [`LuaRegistry::remove_activation`](crate::registrar::LuaRegistry::remove_activation)
...
mod tests {
    use super::*;
    use crate::registrar::new_lua_registry;
    use crossterm::event::{KeyCode, KeyModifiers};
    use ttymap_tui::compositor::{Activation, Component, PaletteEntry};
