...
Each lives as a single `*.lua` (or directory with `init.lua`) under [`runtime/lua/plugin/`](runtime/lua/plugin/) — readable as a tutorial for writing your own.
